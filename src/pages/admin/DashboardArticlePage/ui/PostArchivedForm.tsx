...
function PostArchivedForm({ post, onSuccess }: IPostArchivedFormProps) {
    ...
    const handleDelete = async () => {
        ...
        router.push(ROUTES.admin.dashboard.articles.index.path);
    ...
    return (
        <>
            ...
            <Modal title={`Обновление статуса статьи "${post.title}"`} isOpen={isOpenDeleteModal} onCancel={handleCloseDeleteModal} onClose={handleCloseDeleteModal}>
                <p className="mb-4">Вы уверены, что хотите удалить статью?</p>
